...
export interface SilexExtraBlocPluginOptions {
  label?: string
  flexBoxOptions?: FlexBoxPluginOptions
  basicBlocksOptions?: BasicBlocPluginOptions
}

export interface FlexBoxPluginOptions {
  /**
...
export interface BasicBlocPluginOptions {
  /**
   * Which blocks to add.
